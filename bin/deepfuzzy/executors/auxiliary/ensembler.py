...
from deepfuzzy.core.fuzz import FuzzerFrontend
...
class Ensembler(FuzzerFrontend):
  ...
  NAME = "Ensembler"
  EXECUTABLES = {"FUZZER": "deepfuzzy-ensembler"}

  @classmethod
  def parse_args(cls):
    parser = argparse.ArgumentParser(description="Ensemble-based fuzzer executor for DeepFuzzy")
  ...
  def provision(self):
    ...
    # given a path to a DeepFuzzy harness, provision/compile, and retrieve test bins
