...
#ifndef SRC_INCLUDE_DEEPFUZZY_PLATFORM_H_
#define SRC_INCLUDE_DEEPFUZZY_PLATFORM_H_
...
/* Match a regular expression pattern inside a given string 
  ...
  * See issue: https://github.com/khulnasoft-lab/deepfuzzy/issues/429 */
...
extern int DeepFuzzy_RunTestWin(struct DeepFuzzy_TestInfo *test);

/* Direct run of a single test case. Platform specific function. */
extern void DeepFuzzy_RunSingle();
...
#endif /* SRC_INCLUDE_DEEPFUZZY_PLATFORM_H_ */